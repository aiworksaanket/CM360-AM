...
**Project:** CM360 Attribution
**Generated:** 2026-09-13 02:12:03
...
### Presentation adaptation (V2)

The generated light luxury / Liquid Glass system was adapted for this product:

- This is a **full-screen educational presentation**, not a fashion storefront or Apple chrome UI.
- Background inverted to **warm charcoal-navy** (`#0c0d10`) so the stage feels like a dim screening room.
- Accent stays in the gold family (`#c4a06a`, from `#A16207`) and is used sparingly.
- Channel hues are desaturated and used **only** on attribution marks, never as page chrome.
- Typography: **Bricolage Grotesque** (display) + **Figtree** (body). Cormorant/Montserrat were rejected as luxury-fashion defaults and as saturated training-data pairings.
- Liquid glass / blur chrome is not used. Depth comes from space, type, hairlines, and motion.
- Motion is scene-timed (not scroll-scrub). `prefers-reduced-motion` jumps to the readable end state.
